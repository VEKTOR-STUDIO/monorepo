      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 ref={titleRef} className="font-extrabold text-4xl md:text-5xl tracking-tight mb-6 text-base-content">
            ...
            <span className="text-accent">{renderSegment("confían en username", "seg2")}</span>
          </h2>
          <p ref={subtitleRef} className="text-lg text-base-content/80 max-w-2xl mx-auto">
            Lo que dicen quienes confían en tu empresa para su micropigmentación, 
            microblading, Baby Lips y laminado de cejas. Resultados naturales y profesionales.
          </p>
        </div>

        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <Testimonial
            quote="tu empresa transforma miradas con profesionalismo y detalle. Las cejas quedan naturales y el trato es excelente. Totalmente recomendada."
            author="Cliente"
            role="Microblading"
          />
          <Testimonial
            quote="Baby Lips con username: resultado natural y duradero. Me encantó el color y la simetría. Profesional y muy limpia."
            author="Cliente"
            role="Baby Lips"
          />
          <Testimonial
            quote="Laminado de cejas impecable. username sabe lo que hace: diseño a medida y resultado que dura. No cambio de artista."
            author="Cliente"
        ...
        <div ref={founderRef} className="text-center bg-base-100/60 backdrop-blur-md rounded-2xl p-8 border border-base-content/20">
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="font-black text-2xl text-base-content">tu empresa</p>
            <p className="text-base-content/80 max-w-2xl leading-relaxed">
              Especialista en micropigmentación y arte facial. Microblading, Baby Lips, 
              Laminado de Cejas y más. No solo diseño cejas, diseño confianza.
            </p>
          </div>
        </div>
      </div>
