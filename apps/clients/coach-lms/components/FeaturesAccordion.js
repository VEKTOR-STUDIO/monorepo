...
const services = [
  {
    ...
    duration: "2 – 3 hrs",
    description:
      "La técnica más natural para cejas perfectas. Mediante micro-incisiones superficiales imitamos pelos naturales uno a uno. Resultado: cejas que parecen reales, con duración de 1 a 2 años y difuminado gradual. Ideal para quienes buscan un look completamente natural.",
    svg: (
  ...
  },
  {
    ...
    duration: "2 hrs",
    description:
      "Micropigmentación de labios para un efecto natural y jugoso. Definimos el contorno, aportamos color y volumen visual sin cirugía. El resultado es sutil, femenino y elegante. Duración de 1 a 2 años con cuidados adecuados.",
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
  ...
  },
  {
    ...
    duration: "1 hr",
    description:
      "El tratamiento 'botox' para cejas. Ordenamos, fijamos y damos brillo a cada pelo, creando la ilusión de cejas más llenas y definidas sin pigmentación. Efecto natural con duración de 6 a 8 semanas. Perfecto para mantener el look entre sesiones de microblading.",
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
  ...
  },
  {
    ...
    duration: "2 – 2.5 hrs",
    description:
      "Para quienes buscan mayor intensidad y definición. Añadimos color en toda la zona labial para un efecto más pronunciado que el Baby Lips. Perfecto para labios poco definidos o que han perdido color con los años.",
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
  ...
  },
  {
    ...
    duration: "1.5 hrs",
    description:
      "El mantenimiento que tu micropigmentación necesita. Después de 12 a 18 meses, el color comienza a aclararse naturalmente. El retoque la devuelve a su vivacidad original. Servicio exclusivo para clientas previas.",
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 20% 50%, oklch(72% 0.1 65 / 0.08) 0%, transparent 55%)",
        }}
      />
