...
//   · la OFERTA, que le habla al dueño de Top Miami Cars sobre el sistema
...
const MENSAJES = {
  venta: [
    "Esto es para ti, Top Miami Cars",
  ...
  puertaInversa: [
    ...
    "Panel incluido",
    "Filtros por carrocería",
    "WhatsApp con la unidad escrita",
    "Entrega en 7 días",
  ],
};
...
export default function Cintillo({
  ...
  // Las dos variantes de la puerta comparten el estilo azul de "venta".
