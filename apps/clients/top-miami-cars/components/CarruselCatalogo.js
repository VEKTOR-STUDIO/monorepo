...
//
// Un salón de usados se recorre andando de un carro al siguiente, y esta
...
//     que es el gesto que ya conoce cualquiera con un teléfono.
    ...
    >
      ...
      <div className="relative flex min-h-svh flex-col justify-center py-16 lg:py-0">
        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
          ...
          <p className="mt-4 max-w-md text-sm leading-relaxed text-base-content/65 lg:text-base">
            Las {vehiculos.length} unidades del salón, una por una.{" "}
        ...
        <div className="mt-8 overflow-x-auto overflow-y-hidden pb-5 pt-2 lg:overflow-visible lg:pb-0">
          <div
            ref={pista}
          ...
          >
            {vehiculos.map((vehiculo, i) => (
              ...
              >
                ...
                {/* Nada encima de la imagen: la pieza ya lleva el modelo arriba
                    y la pastilla abajo. El año va debajo. */}
                <div className="p-4">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {vehiculo.esNuevo ? "0 km" : vehiculo.anio}
                    </span>
                    <p className="display-recto min-w-0 truncate text-[0.7rem] text-base-content/70">
                      {vehiculo.tituloLargo}
                    </p>
                  </div>

                  <div className="mt-2.5 flex items-end justify-between gap-3">
                    <p className="display text-xl leading-none text-primary">
                      {enDolares(vehiculo.precio)}
                    </p>
                    <p className="cifra shrink-0 text-[0.65rem] text-base-content/55">
            ...
            >
              <span className="display text-2xl text-primary">Ver todo el inventario</span>
              <span className="text-sm text-base-content/65">
                Con filtros por carrocería, marca, año y precio.
              </span>
