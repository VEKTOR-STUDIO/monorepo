...
const PASOS = [
  ...
  },
  {
    ...
    detalle:
      "Las fotos que ya le hiciste, el precio, el año, el kilometraje y la carrocería. Los mismos datos que hoy escribes en cada estado de WhatsApp, una sola vez.",
  },
  {
    numero: "03",
    titulo: "Queda publicado",
    detalle:
      "Aparece al instante en el inventario y con su enlace propio, listo para mandarlo por WhatsApp o pegarlo donde publiques.",
  },
];
...
function FilaMaqueta({ nombre, precio, estado, tono }) {
  const colores = {
    disponible: "bg-emerald-600/12 text-emerald-700",
    reservado: "bg-amber-500/18 text-amber-700",
    vendido: "bg-base-content/8 text-base-content/55",
  };
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <Revelar retraso={160}>
          <p className="mx-auto mt-6 max-w-2xl text-center leading-relaxed text-base-content/60">
            Cada unidad de esta página la publica el propio equipo de Top Miami Cars
            desde su panel, en un par de minutos y desde el teléfono. Nadie tiene que
            llamar a un programador para subir un carro, cambiar un precio o marcar algo
            como vendido: por eso lo que ves aquí es lo que hay hoy en el salón.
          </p>
        </Revelar>
        ...
        <div className="mt-16 grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <Revelar desde="corte">
            <div className="ficha resplandor overflow-hidden">
              {/* Barra de ventana. */}
              ...
              <div className="bg-base-100 p-4 sm:p-5">
                ...
                <div className="flex items-center justify-between gap-3">
                  <p className="display-recto text-sm tracking-wide">Publicar vehículo</p>
                ...
                <div className="mt-3 border border-dashed border-base-content/18 px-3 py-4 text-center">
                  <p className="text-[0.65rem] text-base-content/40">
                    Arrastra aquí las fotos de la unidad
                  </p>
                </div>
                ...
                <div className="mt-2 overflow-hidden border border-base-content/8">
                  <FilaMaqueta
                    nombre="Ford Explorer Limited 2017"
                    precio="$22.500"
                    estado="Disponible"
                    tono="disponible"
                  />
                  <FilaMaqueta
                    nombre="Honda Civic EX 2017"
                    precio="$14.500"
                    estado="Reservado"
                    tono="reservado"
                  />
                  <FilaMaqueta
                    nombre="Chevrolet Silverado LT 2014"
                    precio="$18.900"
                    estado="Vendido"
                    tono="vendido"
                  />
          ...
          <div>
            ...
            <Revelar retraso={360}>
              <div className="panel mt-7 bg-base-100! p-5">
