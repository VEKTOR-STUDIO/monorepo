...
export default function Privacidad() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-12">
      ...
      <h1 className="display mt-8 text-2xl text-primary sm:text-3xl">Política de privacidad</h1>
      ...
      <div className="mt-10 space-y-8 leading-relaxed text-base-content/75">
        <section>
          <h2 className="display text-base text-base-content">Qué datos recogemos</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="display text-base text-base-content">Para qué los usamos</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="display text-base text-base-content">Cookies</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="display text-base text-base-content">Tus derechos</h2>
          <p className="mt-3">
            Puedes pedirnos que borremos tus datos cuando quieras, escribiendo por
            WhatsApp al{" "}
