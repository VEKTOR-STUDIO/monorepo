    ...
    <main className="mx-auto max-w-2xl px-5 py-12">
      ...
      <div className="mt-10 space-y-8 leading-relaxed text-base-content/75">
        <section>
          ...
          <p className="mt-3">
            {config.appName} publica los vehículos disponibles en el
            concesionario, los que entran en consignación y los servicios del
            taller. La página no cobra, no procesa pagos y no retiene dinero de
            ninguna operación: todo se cierra en persona o por WhatsApp.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            Recomendamos siempre inspeccionar el vehículo en persona y, si se
            quiere, llevarlo a un taller de confianza antes de comprar. La
            inspección es responsabilidad del comprador.
          </p>
        </section>

        <section>
          <h2 className="display text-lg text-base-content">4. Consignación y taller</h2>
          <p className="mt-3">
            Los vehículos en consignación siguen siendo de su propietario hasta
            que se firme la venta; las condiciones de cada consignación se
            acuerdan por escrito entre las partes. Los trabajos del taller
            —accesorios, detailing— se presupuestan aparte y no forman parte del
            precio publicado del vehículo salvo que la ficha lo diga.
          </p>
        </section>
