...
export const metadata = getSEOTags({
  ...
  description: `Escríbenos por WhatsApp o Instagram para comprar, consignar tu vehículo o cotizar accesorios y detailing en ${business.ciudad}.`,
...
export default function Contacto() {
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden border-b border-base-content/10 bg-base-200 px-4 py-20 sm:px-6">
          <Image
          ...
          <div className="relative mx-auto max-w-7xl">
            <Revelar>
              ...
              <p className="mt-4 max-w-lg text-lg text-base-content/70">
                Lo más rápido es WhatsApp: para comprar, para consignar tu vehículo
                o para cotizar accesorios. Si prefieres, déjanos qué buscas y te
                escribimos nosotros.
              </p>
            </Revelar>
          </div>
            ...
            <Revelar retraso={120}>
              <div className="ficha p-7 sm:p-9">
                ...
                <p className="mt-3 text-sm leading-relaxed text-base-content/55">
                  ...
                  También tasamos el vehículo que quieras dejar en consignación y
                  cotizamos el trabajo del taller.
                </p>
