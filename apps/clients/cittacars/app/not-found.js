  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-base-200 px-6 text-center">
      ...
      <div
        ...
        aria-hidden="true"
      >
        <Silueta tipo="camioneta" className="w-[120%] max-w-3xl text-base-content" />
      </div>

      <div className="relative">
        <p className="cifra text-7xl font-bold text-primary/40 sm:text-8xl">404</p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Link href="/contacto" className="btn btn-ghost border border-base-content/20">
            Escribirnos
          </Link>
        </div>
