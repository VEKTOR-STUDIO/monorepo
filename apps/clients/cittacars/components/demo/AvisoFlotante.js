...
const LLAVE = "cittacars.demo.aviso-cerrado";
...
export default function AvisoFlotante() {
  ...
  return (
    <div
      ...
      aria-hidden={!visible}
    >
      <div className="ficha pointer-events-auto w-full max-w-sm p-5 shadow-2xl shadow-black/60">
        <button
          type="button"
          onClick={cerrar}
        ...
        <p className="mt-2.5 pr-5 text-sm leading-relaxed text-base-content/70">
          Inventario, ficha por vehículo, taller, consignación y contacto directo
          por WhatsApp. Todo esto funcionando, con tu marca y tus vehículos.
        </p>
