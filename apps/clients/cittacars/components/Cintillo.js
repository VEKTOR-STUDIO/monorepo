...
//
//   · el ESCAPARATE, que le habla a quien viene a comprar una camioneta;
//   · la OFERTA, que le habla al dueño de @cittacars sobre el sistema que se
//     le está vendiendo.
//
...
const MENSAJES = {
  venta: [
    "Esto es para ti, dueño de Citta Cars",
  ...
  puertaInversa: [
    ...
    "Panel incluido",
    "Taller y consignación incluidos",
