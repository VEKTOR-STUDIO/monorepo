...
const PASOS = [
  ...
  },
  {
    ...
    detalle:
      "Fotos, precio, año, kilometraje, los accesorios que trae montados y el texto que ya escribes para Instagram. Los mismos datos, una sola vez.",
  },
  {
    numero: "03",
...
function FilaMaqueta({ nombre, precio, estado, tono }) {
  const colores = {
    ...
    reservado: "bg-amber-400/15 text-amber-300",
  ...
  return (
    <div className="flex items-center gap-3 border-t border-base-content/8 px-4 py-2.5">
      <span className="size-7 shrink-0 rounded-lg bg-base-content/10" aria-hidden="true" />
      ...
      <div className="relative mx-auto max-w-7xl">
        <Revelar className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl leading-relaxed text-base-content/60">
            Cada vehículo de esta página lo publica el propio equipo de Citta Cars
            desde su panel, en un par de minutos. Nadie tiene que llamar a un
            programador para subir una camioneta, cambiar un precio o marcar algo
        ...
        <div className="mt-14 grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <Revelar desde="izquierda">
            <div className="ficha overflow-hidden shadow-2xl shadow-black/40">
              {/* Barra de ventana. */}
              <div className="flex items-center gap-2 border-b border-base-content/10 bg-base-300/60 px-4 py-2.5">
                <span className="size-2.5 rounded-full bg-base-content/20" aria-hidden="true" />
                <span className="size-2.5 rounded-full bg-base-content/20" aria-hidden="true" />
                <span className="size-2.5 rounded-full bg-base-content/20" aria-hidden="true" />
              ...
              <div className="bg-base-100 p-4 sm:p-5">
                ...
                <div className="mt-4 grid grid-cols-2 gap-2.5">
                  {[
                    ...
                    <div key={etiqueta}>
                      ...
                      <div className="mt-1 rounded-md border border-base-content/12 bg-base-content/5 px-2.5 py-1.5">
                ...
                {/* Zona de fotos. */}
                <div className="mt-3 rounded-md border border-dashed border-base-content/20 px-3 py-4 text-center">
                ...
                <div className="mt-2 overflow-hidden rounded-md border border-base-content/10">
                  ...
                  <FilaMaqueta nombre="Mazda 6 2017" precio="$18.500" estado="Vendido" tono="vendido" />
                </div>
              </div>
            </div>
          </Revelar>
