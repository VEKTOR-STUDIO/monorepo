...
export default async function Vehiculo({ params }) {
  ...
  // Parecidos: primero los de la misma condición y carrocería, que es lo que de
  // verdad ayuda a quien todavía no se ha decidido; si no salen tres, se
  // completa con los de la misma condición. A quien está mirando usados no se
  // le propone un 0 km del doble de precio: es cambiarle la conversación.
    ...
    <>
      ...
      <main>
        ...
        <div className="mx-auto max-w-7xl px-4 pt-6 sm:px-6">
          <Link
            href="/vehiculos"
            className="display-abierto text-xs tracking-widest text-base-content/50 transition-colors hover:text-primary"
          >
                ...
                <Revelar retraso={180}>
                  ...
                  <div className="mt-8">
                    ...
                    <p className="mt-2 text-sm text-base-content/60">
                      Se ve y se prueba en {vehiculo.ubicacion}, en el {config.business.centroLargo}
                    </p>
                  </div>
                </Revelar>
                  ...
                  <div className="mt-8">
                    {demo ? (
                      <AvisoBloqueado titulo="El contacto está desactivado en la demo">
                        En la página entregada, este botón abre la conversación con el
                        mensaje ya escrito —«me interesa el {vehiculo.tituloLargo}{" "}
                        {vehiculo.anio} que vi en la página, ¿sigue disponible? Quisiera ir
                        a verlo»— por el WhatsApp de tu bio, para que el comprador no tenga
                        que explicar nada ni mandar una captura.
                      </AvisoBloqueado>
                    ) : (
                      <BotonContacto
                        vehiculo={vehiculo}
                      ...
                      {vehiculo.detalles.map((detalle) => (
                        <li key={detalle} className="flex gap-3 text-sm leading-snug">
                          <span
                            ...
                            aria-hidden="true"
                          />
                          <span className="display-abierto tracking-wide text-base-content/80">
                            {detalle}
                          </span>
                        </li>
                      ))}
            ...
            <div className="mt-20 grid gap-12 border-t border-base-content/10 pt-12 lg:grid-cols-2 lg:gap-20">
              <Revelar>
                ...
                <p className="mt-8 text-sm leading-relaxed text-base-content/45">
                  Se ve y se prueba en el {config.business.direccionLarga}. Escribe antes
                  por WhatsApp y te confirmamos que sigue disponible.
                </p>
              </Revelar>
          ...
          <section className="relative overflow-hidden border-t border-base-content/8 bg-base-200 px-4 py-20 sm:px-6">
            ...
            <div className="relative mx-auto max-w-7xl">
              ...
              <TituloAnimado as="h2" className="display mt-4 text-3xl sm:text-4xl">
                {vehiculo.esNuevo ? "Otros 0 km" : "Otros usados"}
              </TituloAnimado>
