import { Exo_2, Archivo, JetBrains_Mono } from "next/font/google";
...
// "CORONADO CARSS" está escrito en una grotesca técnica, gruesa, de esquinas
// cuadradas con el canto redondeado y EN CURSIVA, y "Servimos con Excelencia"
// en la misma familia en peso normal. Exo 2 es lo más cerca que se llega con
// una tipografía libre: tiene esa misma R y esa misma S, y en 800 itálica es
// lo que le da a la página el aire de pieza suya en vez de aire de plantilla.
const exo = Exo_2({
  subsets: ["latin"],
...
// contrapeso: si el texto corrido también fuera técnico y en cursiva, la
// página entera se leería como un cartel.
...
// en lo que le habla al dueño de Coronado Carss, igual que en el resto del
// monorepo.
...
export default function RootLayout({ children }) {
  ...
  return (
    <html
      ...
      className={`${exo.variable} ${archivo.variable} ${jetbrains.variable} ${microgramma.variable}`}
    >
      <head>
        {renderSchemaTags()}
