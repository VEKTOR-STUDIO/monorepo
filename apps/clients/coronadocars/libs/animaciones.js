...
//
// El movimiento de esta página no es decorativo. La gráfica de Coronado Carss
// son cajas azules cortadas en diagonal, un filete amarillo y un nombre en
// cursiva, así que aquí las cosas no giran: ENTRAN DE LADO, en la pendiente de
// la casa, y se posan. Las líneas del titular suben desde detrás de una
// máscara, las cajas de datos entran una detrás de otra como se leen en sus
// posts, y las bandas del fondo se deslizan despacio.
//
...
/**
 * La pendiente de la marca, en grados.
 *
 * Es la de la cursiva de "CORONADO CARSS" y la del lado cortado de las cajas
 * de sus posts: la misma inclinación en las dos, y la de toda la página. Tiene
 * que ir a la par con --angulo-cc de app/globals.css.
 */
