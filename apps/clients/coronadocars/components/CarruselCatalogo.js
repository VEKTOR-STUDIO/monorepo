      ...
      <div className="relative flex min-h-svh flex-col justify-center py-16 lg:py-0">
        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
          ...
          <p className="mt-4 max-w-md text-sm leading-relaxed text-base-content/55 lg:text-base">
            Las {vehiculos.length} unidades, una por una: usados y 0 km.{" "}
          ...
          >
              ...
              >
                ...
                <div className="p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="display-abierto min-w-0 truncate text-xs tracking-wide text-base-content/60">
                      {vehiculo.tituloLargo}
                    </p>
                  </div>

                  <div className="mt-2.5 flex items-end justify-between gap-3">
                    <p className="cifra text-xl font-bold leading-none">
            ...
            >
              ...
              <span className="text-sm text-base-content/55">
                Con filtros por condición, carrocería, marca y precio.
              </span>
