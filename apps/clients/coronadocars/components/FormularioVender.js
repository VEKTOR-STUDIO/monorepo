 ...
 *
 * Es el otro lado del negocio y el que Coronado Carss anuncia en su publicación
 * fijada ("¿Quieres vender tú…?") y en su propio logotipo ("Compra - Venta y
 * Consignación"). Lo que hace falta para arrancar el avalúo es lo que se pide
 * aquí y nada más: cómo contactarte y qué carro es. Pedir veinte campos en el primer paso
  ...
  return (
    <form onSubmit={enviar} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={enviando}
        className="btn btn-azul w-full sm:w-auto sm:px-10"
      >
        {enviando ? "Enviando…" : "Pedir mi avalúo"}
      </button>
    </form>
  );
}
