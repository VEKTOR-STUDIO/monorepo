 ...
 * fotos de Coronado Carss son publicaciones ya maquetadas con su gráfica —la
 * etiqueta del modelo, su recuadro y la fila de cajas con año, modelo,
 * kilometraje y transmisión— y recortarlas sería tirar a la basura lo mejor
 * que tienen. El hueco que queda alrededor lo tapa el fondo de estudio, así
 * que no se nota que haya hueco.
 *
 * Cuando NO hay foto —que hoy es siempre— se dibuja la plantilla de sus propias
 * publicaciones: la pared del local, la silueta de la carrocería, la etiqueta
 * y las cajas. Así el hueco de la foto enseña exactamente dónde va a ir su
 * foto, y con su gráfica, en vez de dejar un rectángulo vacío.
 */
 ...
 *
 * No es un detalle menor y por eso se dice en voz alta: de Coronado Carss no
 ...
 *
 * Coronado Carss NO publica precios: sus fichas dicen año, modelo, kilometraje
 * y transmisión, y el precio se da por WhatsApp. Todos los precios de esta
 * demo son referencias de mercado, puestas para que la página se pueda enseñar
 * funcionando, y decir eso en voz alta es la diferencia entre una demo honesta
 * y una que se inventa el inventario de otro.
 *
...
export function AvisoPrecioProvisional({ className = "" }) {
  return (
    ...
    >
      ...
      Precio de referencia: tus fichas no publican precio
    </span>
  );
}
