      ...
      <div className="relative mx-auto max-w-5xl px-4 py-20 sm:px-6">
        ...
        <Revelar retraso={140}>
          <p className="mx-auto mt-6 max-w-lg text-center leading-relaxed text-base-content/60">
            No es una maqueta: es una página real funcionando, hecha con tu recuadro,
            tus colores y la gráfica de tus publicaciones. Lo que falta por poner es
        ...
        <Revelar retraso={180}>
          <p className="mx-auto mt-6 max-w-lg text-center text-xs text-base-content/35">
            De todo el inventario que ves, solo el Yaris Belta 2008 es tuyo —su año,
            su kilometraje y su transmisión, leídos de tu publicación—; el resto son
            unidades de muestra, y todos los precios son de referencia porque tus
            fichas no los publican. Tampoco hay ni una foto tuya: lo que ves dibujado
            es la plantilla de tus posts. Todo eso se carga desde el panel.
          </p>
        </Revelar>
      </div>
    </section>
