...
const LLAVE = "coronado-carss.demo.aviso-cerrado";
    ...
    >
      <div className="ficha pointer-events-auto w-full max-w-sm p-5 shadow-2xl shadow-black/50">
        ...
        <p className="mt-2.5 pr-5 text-sm leading-relaxed text-base-content/70">
          Tu Instagram convertido en página: usados y 0 km, ficha por unidad y el
          botón de WhatsApp con el carro ya escrito. Con tu azul y tu amarillo.
        </p>
