...
const LLAVE = "lm2006.demo.aviso-cerrado";
    ...
    >
      <div className="ficha pointer-events-auto w-full max-w-sm p-5 shadow-2xl shadow-black/50">
        ...
        <p className="mt-2.5 pr-5 text-sm leading-relaxed text-base-content/70">
          Tu Instagram convertido en página: inventario, ficha por unidad y
          contacto directo por WhatsApp. Con tu azul y tus tres barras.
        </p>
