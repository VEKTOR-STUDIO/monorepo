 ...
 *
 * Es el movimiento principal de la página, y no es un adorno: en sus
 * publicaciones el modelo entra cortado contra el fondo, y esto es lo mismo en
 * movimiento —el texto no aparece, SALE de detrás de algo—.
 *
