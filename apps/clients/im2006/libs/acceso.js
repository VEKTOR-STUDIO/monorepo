...
export const COOKIE_ACCESO = "lm2006_acceso";
 ...
 */
const CLAVE_POR_DEFECTO = "lm2006caracas";
...
export async function huellaDe(clave) {
  // El nombre del cliente va de sal: si dos demos del monorepo acabaran con la
  // misma contraseña, la cookie de una no valdría en la otra.
  const datos = new TextEncoder().encode(`lm-2006::acceso::${clave}`);
