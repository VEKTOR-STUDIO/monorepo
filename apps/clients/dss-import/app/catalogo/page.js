...
export const metadata = getSEOTags({
  title: `Catálogo | ${config.appName}`,
  description:
    "Vehículos y motos con plan de crédito en Maracay, estado Aragua. Filtra por cuota máxima, tipo, condición y marca; cada unidad con su cuota, su inicial y su plazo.",
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <Revelar retraso={200}>
              <p className="mt-5 max-w-xl leading-relaxed text-base-content/60">
                Todo lo que se puede financiar ahora mismo: vehículos y motos, cada uno
                con su cuota, su inicial y su plazo a la vista. Filtra por lo que puedas
                pagar a la semana y quédate solo con lo que te entra.
              </p>
            </Revelar>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            {lista.length === 0 ? (
              <div className="panel mt-10 p-14 text-center">
                ...
                <p className="mt-3 text-sm text-base-content/55">
                  Prueba a subir la cuota máxima o a quitar algún filtro; el catálogo
                  cambia cada semana.
                </p>
              </div>
            ) : (
            ...
            {(hayPreciosProvisionales() || hayUnidadesDeMuestra()) && (
              <div className="mt-12 flex flex-wrap justify-center gap-3">
                ...
                {lista.some((v) => v.cuota?.calculada) && <AvisoCuotaCalculada />}
              </div>
            )}
          </div>
        </section>
