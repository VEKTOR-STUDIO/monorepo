 ...
 *
 * Aquí manda la firma de Vektor y no la marca de DSS: quien llega
 * todavía no es cliente de DSS, es alguien a quien se le está enseñando un
...
export default function PantallaAcceso({ destino = "/" }) {
  ...
  return (
    <main ref={raiz} className="puerta relative flex h-svh flex-col overflow-hidden bg-base-100">
      ...
      {/* Velo. Sin él, el rótulo y el precio —que van en oro— caen justo
          encima del cielo dorado del escenario y desaparecen: oro sobre oro. El
          velo baja el fondo lo justo para que se siga viendo y el texto se lea
          encima. */}
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, color-mix(in oklab, var(--color-oro) 35%, transparent), transparent 62%)",
          filter: "blur(90px)",
        }}
      />
      ...
      {/* ---------------- Cuerpo ----------------
          ...
          El `z-10` abre un contexto de apilamiento, que es lo que apaga un
          `mix-blend-mode`. Aquí da igual: el sello de DSS no se funde con nada,
          se recorta en redondo con `.sello` (ver components/Logo.js), y a un
          `border-radius` no le afecta el contexto de apilamiento. */}
          ...
          <div className="flex min-w-0 flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <div data-puerta="logo" className="mt-[var(--puerta-v3)] flex flex-col items-center lg:items-start">
              ...
              <div className="mt-[var(--puerta-v1)] flex items-center gap-4">
                ...
                <MarcaDSS className="text-[clamp(1rem,3vh,1.75rem)]" />
              </div>
              <h1 className="display mt-[var(--puerta-v2)] text-[clamp(1.4rem,3.8vh,2.5rem)]">
            ...
            <p data-puerta="titulo" className="puerta-presentacion mt-[var(--puerta-v3)] max-w-md leading-relaxed text-sm text-base-content/65">
              Tus planes de crédito hechos página web, enteros y funcionando: vehículos y
              motos separados, la cuota primero como en tus piezas, un simulador donde el
              cliente arma su plan, y la gráfica de tus publicaciones —el cielo dorado, la
              ciudad, el asfalto—. Entra con tu contraseña y recórrela.
            </p>
