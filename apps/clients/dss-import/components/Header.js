...
// El primer corte del menú es el del negocio: vehículos por un lado, motos por
// el otro. Es la división que ellos mismos escriben en su bio —"planes de
// créditos para vehículos y motos"— y son dos compradores que no se parecen en
// nada: uno financia el carro de la familia a dos años, el otro se lleva una
// moto de trabajo con cuota mensual.
const ENLACES = [
  { href: "/catalogo?segmento=auto", texto: "Vehículos" },
  { href: "/catalogo?segmento=moto", texto: "Motos" },
  { href: "/catalogo", texto: "Todo el catálogo" },
  { href: "/#como-funciona", texto: "Cómo funciona" },
  { href: "/#oficina", texto: "La oficina" },
  { href: "/contacto", texto: "Solicitar crédito" },
];
