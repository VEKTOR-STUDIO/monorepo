...
// -----------------------------------------------------------------------------
// "El catálogo lo suben ellos".
//
// La sección funciona en dos planos a la vez, y por eso está redactada así:
//
//   · Para quien viene a financiar una unidad: explica por qué lo que ve está
//     al día —lo publica el propio equipo, no un programador cada quince días—.
//   · Para quien viene a comprar la página: enseña que no queda atado a nadie
//     para actualizar su catálogo ni sus cuotas, que es la objeción número uno.
//
...
const PASOS = [
  ...
  {
    numero: "02",
    titulo: "Cargas la unidad",
    detalle:
      "La foto que ya hiciste para el post, la cuota, la inicial, el plazo y si es vehículo o moto. Los mismos datos que ya escribes en el cartel, una sola vez.",
  },
  {
    numero: "03",
    titulo: "Queda publicada",
    detalle:
      "Aparece al instante en el catálogo y con su enlace propio, listo para pegarlo en la publicación o mandarlo por WhatsApp.",
  },
];
...
function FilaMaqueta({ nombre, precio, estado, tono }) {
  const colores = {
    ...
    entregado: "bg-base-content/10 text-base-content/45",
  };
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <Revelar retraso={160}>
          <p className="mx-auto mt-6 max-w-2xl text-center leading-relaxed text-base-content/60">
            Cada unidad de esta página la publica el propio equipo de DSS desde su
            panel, en un par de minutos, desde la oficina o desde el teléfono. Nadie
            tiene que llamar a un programador para subir una moto, cambiar una cuota o
            marcar algo como entregado: por eso lo que ves aquí es lo que hay hoy.
          </p>
        </Revelar>
            ...
            <div className="ficha overflow-hidden shadow-2xl shadow-black/40">
              ...
              <div className="bg-base-100 p-4 sm:p-5">
                ...
                <div className="flex items-center justify-between gap-3">
                  <p className="display-recto text-sm tracking-wide">Publicar unidad</p>
                ...
                <div className="mt-2 overflow-hidden border border-base-content/8">
                  <FilaMaqueta
                    nombre="Dodge Caliber SXT 2007"
                    precio="$75 sem."
                    estado="Disponible"
                    tono="disponible"
                  />
                  <FilaMaqueta
                    nombre="Hyundai Accent GLS 2009"
                    precio="$75 sem."
                    estado="Reservado"
                    tono="reservado"
                  />
                  <FilaMaqueta
                    nombre="Bera SBR 2026"
                    precio="$70 mes"
                    estado="Entregada"
                    tono="entregado"
                  />
            ...
            <Revelar retraso={360}>
              <div className="panel mt-7 p-5">
                <p className="text-sm leading-relaxed text-base-content/65">
                  ...
                  página y el catálogo es tuyo, no de nadie más.
                </p>
              </div>
            </Revelar>
          </div>
