      ...
      <div className="absolute inset-x-0 top-6 flex justify-center px-4">
        <div className="ficha w-full max-w-md p-7 text-center shadow-2xl shadow-black/50">
          ...
          <p className="mt-3 text-sm leading-relaxed text-base-content/60">
            La página completa lleva todo el catálogo, la ficha de cada unidad con su
            simulador de cuota, el corte entre vehículos y motos, y el botón que llega
            con el modelo y la cuota ya escritos en el mensaje.
          </p>
