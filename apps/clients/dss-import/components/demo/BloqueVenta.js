      ...
      <div className="relative mx-auto max-w-5xl px-4 py-20 sm:px-6">
        ...
        <Revelar retraso={140}>
          <p className="mx-auto mt-6 max-w-lg text-center leading-relaxed text-base-content/60">
            No es una maqueta: es una página real funcionando, hecha con tu sello, tu
            oro y la gráfica de tus publicaciones. Lo que falta por poner es tu catálogo
            completo, tus fotos, tu WhatsApp y tu dominio.
          </p>
        </Revelar>
        ...
        <Revelar retraso={180}>
          <p className="mx-auto mt-6 max-w-lg text-center text-xs text-base-content/35">
            Las seis primeras unidades salen de tus propias publicaciones, con tus
            cuotas tomadas del cartel; el resto son de muestra y su cuota va calculada.
            Los precios de contado son referencias —tus piezas no los llevan— y no hay
            ni una foto tuya, porque Instagram limitó las peticiones desde aquí: lo que
            ves dibujado es la plantilla de tus posts. Todo eso se carga desde el panel.
          </p>
        </Revelar>
      </div>
    </section>
