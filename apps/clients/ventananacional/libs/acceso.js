...
export const COOKIE_ACCESO = "vn_acceso";
 ...
 */
const CLAVE_POR_DEFECTO = "ventanacional2026";
 ...
 *
 * El prefijo lleva el nombre del cliente y hace de sal: si dos demos del
 * monorepo acaban con la misma contraseña, la cookie de una NO sirve en la
 * otra.
 */
export async function huellaDe(clave) {
  const datos = new TextEncoder().encode(`ventanacional::acceso::${clave}`);
