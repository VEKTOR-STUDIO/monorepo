      ...
      <div className="relative z-10 mx-auto grid max-w-6xl gap-10 px-5 py-12 lg:grid-cols-[1.15fr_1fr] lg:gap-14 lg:py-16">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <div data-puerta="logo" className="mt-8 flex flex-col items-center lg:items-start">
            ...
            <LogoFoto lado={132} className="mt-3" prioridad />
            <h1 className="display mt-4 text-4xl sm:text-5xl">
              <span className="cromo">Venta Nacional</span>
            </h1>
            <p className="cifra mt-1 text-[0.6rem] uppercase tracking-[0.24em] text-base-content/40">
          ...
          <div className="mt-9 w-full">
            ...
            <ul data-puerta="dlc" className="mt-4 space-y-2">
              {incluye.map((cosa, i) => (
                <li
                  key={cosa}
                  className="linea-dlc flex items-start gap-3 rounded-xl px-4 py-3 text-left"
                >
        ...
        <div className="lg:sticky lg:top-8 lg:self-start">
          <div
            data-puerta="caja"
            className="vidrio vidrio-denso resplandor relative p-6 sm:p-7"
          >
            ...
            <div className="mt-3 flex items-end gap-3">
              ...
              <span className="cifra text-5xl font-bold leading-none text-primary">{precio}</span>
            </div>
            ...
            {/* La llave. */}
            <form onSubmit={enviar} className="mt-7 border-t border-white/12 pt-6">
