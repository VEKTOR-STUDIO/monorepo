...
const LLAVE = "ventanacional.demo.aviso-cerrado";
...
export default function AvisoFlotante() {
  ...
  return (
    <div
      ...
      aria-hidden={!visible}
    >
      <div className="ficha vidrio-denso pointer-events-auto w-full max-w-sm p-5">
        <button
          type="button"
          onClick={cerrar}
          className="absolute right-2.5 top-2.5 rounded-xl p-1.5 text-base-content/45 transition-colors hover:bg-white/10 hover:text-base-content"
        ...
        <p className="mt-2.5 pr-5 text-sm leading-relaxed text-base-content/70">
          Inventario, ficha por vehículo, las dos salas y contacto directo por
          WhatsApp. Todo esto funcionando, con tu marca y tus vehículos.
        </p>
