...
const PASOS = [
  ...
  },
  {
    ...
    detalle:
      "Fotos, precio, año, kilometraje, en qué sala está y el texto que ya escribes para Instagram. Los mismos datos, una sola vez.",
  },
  {
    numero: "03",
...
function FilaMaqueta({ nombre, precio, estado, tono }) {
  const colores = {
    ...
    vendido: "bg-white/8 text-base-content/45",
  };

  return (
    <div className="flex items-center gap-3 border-t border-white/8 px-4 py-2.5">
      <span className="size-7 shrink-0 rounded-xl bg-white/8" aria-hidden="true" />
      ...
      <span className={`rounded-xl px-2 py-0.5 text-[0.6rem] font-medium ${colores[tono]}`}>
        {estado}
      </span>
    </div>
  );
      ...
      <div className="relative mx-auto max-w-7xl">
        <Revelar className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl leading-relaxed text-base-content/60">
            ...
            un carro, cambiar un precio, moverlo de sala o marcarlo como vendido:
            por eso lo que ves aquí es lo que hay hoy.
          </p>
        </Revelar>
        ...
        <div className="mt-14 grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <Revelar desde="izquierda">
            <div className="vidrio overflow-hidden">
              {/* Barra de ventana. */}
              <div className="flex items-center gap-2 border-b border-white/10 bg-white/4 px-4 py-2.5">
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="rounded-xl bg-primary px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-wider text-primary-content">
                    Guardar
                  </span>
                </div>
                ...
                <div className="mt-4 grid grid-cols-2 gap-2.5">
                  {[
                    ...
                    <div key={etiqueta}>
                      ...
                      <div className="mt-1 rounded-xl border border-white/10 bg-white/5 px-2.5 py-1.5">
                ...
                {/* Zona de fotos. */}
                <div className="mt-3 rounded-xl border border-dashed border-white/15 px-3 py-4 text-center">
