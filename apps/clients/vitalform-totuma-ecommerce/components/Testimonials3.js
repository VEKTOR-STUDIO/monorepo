...
const list = [
  {
    username: "soyfelizola",
    name: "Barbara Felizola",
    // REQUIRED
    text: "Really easy to use. The tutorials are really useful and explains how everything works. Hope to deploy my next project really fast!",
  ...
  },
  {
    username: "wahab",
    name: "Wahab Shaikh",
    text: "Easily saves 15+ hrs for me setting up trivial stuff. Now, I can directly focus on deployping features rather than hours of setting up the same technologies from scratch. Feels like a super power! :D",
  },
];
        ...
        <div className="flex flex-col text-center w-full mb-20">
          <div className="mb-8">
            <h2 className="sm:text-5xl text-4xl font-extrabold text-base-content">
              212 makers are already deployping faster!
            </h2>
          </div>
