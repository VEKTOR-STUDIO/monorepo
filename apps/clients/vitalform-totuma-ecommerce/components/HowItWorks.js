      ...
      >
        ...
        <div className="relative mb-6">
          <div className="w-14 h-14 border border-primary/30 flex items-center justify-center group-hover:border-primary/70 transition-all duration-300">
            <span
              className="text-xl font-bold text-primary/70 group-hover:text-primary transition-colors duration-300"
  ...
  const steps = [
    {
      ...
      description:
        "Explora el menú de servicios y elige el que más resuene contigo. Microblading, Baby Lips, Laminado... cada opción es una puerta a tu mejor versión.",
    },
    {
      number: "II",
      title: "Reserva tu Cita",
      description:
        "Selecciona fecha y hora que se adapte a tu agenda. El proceso es simple, rápido y completamente en línea. Sin llamadas innecesarias, sin esperas.",
    },
    {
      number: "III",
      title: "Vive tu Transformación",
      description:
        "Llega, relájate y confía. Te guío en cada paso del proceso. Sales con una versión más radiante y segura de ti misma.",
    },
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-base-content/60 text-lg max-w-xl mx-auto leading-relaxed">
            Tres pasos simples para vivir la experiencia con Barbara Felizola.
          </p>
        </div>
            ...
            <svg className="w-full h-2" preserveAspectRatio="none">
              <defs>
                <linearGradient id="lineGradPMU" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="oklch(72% 0.1 65)" stopOpacity="0.5" />
                  <stop offset="100%" stopColor="oklch(76% 0.12 75)" stopOpacity="0.5" />
                </linearGradient>
              </defs>
              <line
                ref={line1Ref}
