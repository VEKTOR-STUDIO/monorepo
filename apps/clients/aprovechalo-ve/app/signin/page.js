...
function SignInForm() {
  ...
  // Sin Supabase configurado no hay a quién pedirle la sesión: se dice y ya.
  const sinAuth = () => {
    setError(
      "El inicio de sesión todavía no está configurado. Escríbenos por WhatsApp y te atendemos igual."
    );
    setLoading(false);
  };
