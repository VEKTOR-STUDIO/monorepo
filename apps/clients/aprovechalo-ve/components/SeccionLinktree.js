...
//
// Habla el vendedor del sistema, no Aprovéchalo: por eso va en la zona marcada
...
const COMPARACION = [
  {
    ...
    pagina: "El inventario completo: foto, año, kilometraje y precio, sin preguntar nada.",
  },
  {
    tema: "El enlace del perfil",
    linktree: "Uno solo para todo. El mismo para el post de la camioneta que para el de la moto.",
    pagina: "Uno por vehículo. Pegas el del carro en su publicación o se lo mandas por WhatsApp.",
  },
  {
    tema: "De quién es la dirección",
    linktree: "linktr.ee/tu-nombre: la marca que se lee primero es la de ellos.",
    pagina: "Tu dominio, en el perfil, en la tarjeta y en el cartel de la camioneta.",
  },
  {
    tema: "Quien busca en Google",
    linktree: "No te encuentra: una lista de enlaces no dice qué vehículos tienes.",
    pagina: "Cada ficha se indexa con su marca, modelo, año y ciudad.",
  },
  {
    tema: "Buscar dentro",
      ...
      <div className="relative mx-auto max-w-5xl">
        <Revelar className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl leading-relaxed text-base-content/60">
            ...
            minutos. El problema no es ese. Es que un negocio que mueve vehículos de
            cinco cifras necesita que el cliente vea el inventario, no una lista de
            botones que lo obliga a escribir para saber qué hay.
          </p>
        </Revelar>
