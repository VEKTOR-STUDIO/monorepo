...
export const metadata = getSEOTags({
  ...
  description:
    `Noticias y contenido de ${config.appName} — Preparador físico y entrenamiento de élite en Caracas.`,
    ...
    <>
      <section className="text-center max-w-xl mx-auto mt-12 mb-24 md:mb-32">
        <h1 className="font-extrabold text-3xl lg:text-5xl tracking-tight mb-6">
          Blog de {config.appName}
        </h1>
        <p className="text-lg opacity-80 leading-relaxed">
          Noticias, fisioterapia, BJJ y bienestar. Lo último sobre terapia, rehabilitación y entrenamiento.
        </p>
      </section>
