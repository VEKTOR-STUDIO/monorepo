...
export const CAOS_OATH = {
  ...
  lead: [
    "Esto es el Torneo CAOS. Se rolea una vez. Lo que salga, se pelea.",
    "Pero eso no quiere decir que todo valga.",
  ],
  nos: [
    "Un dado decide el terreno y el duelo.",
    "No se negocia el terreno.",
    "No se cambia el duelo.",
    "No se cambia de roleo.",
  ],
  pay: [
    "El terreno vale para ambos.",
    "Ganar con desventaja paga doble. Finalizar paga.",
    "A menos que las cartas digan lo contrario.",
  ],
  ref: "Lo que no esté en la carta, lo decide el árbitro.",
  clean: "Que quede limpio. Que sea corto.",
...
export const CAOS_STEPS = [
  ...
  },
  {
    ...
    long: "A uno le toca la ventaja y al otro la desventaja. Remontar desde abajo paga el doble de puntos CAOS; guindarse de la ventaja sin finalizar no paga nada. Esos puntos van al ranking CAOS, no al cinturón.",
  },
];
