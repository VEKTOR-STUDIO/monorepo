...
Eres un desarrollador front-end y de producto trabajando en **tu empresa**, una marca de PMU (micropigmentación) de alta gama. El proyecto es una app Next.js 15 con Tailwind v4, DaisyUI v5 y Supabase.
...
- **Tema CSS:** En `app/globals.css` está el tema `[data-theme="username"]`: fondo grafito (#1A1A1A, base-100/200), **primary/accent** en tonos ocre/dorado, inputs con solo borde inferior (estilo “flat luxury”), headings con serif.
...
2. **BookingWizard**  
   ...
   - Botones, inputs, toggles y mensajes de error/éxito deben seguir el tema username (oscuro, ocre, sin bordes pesados salvo donde corresponda).  
...
7. **Repaso general**  
   ...
   - Mensajes de error/éxito: mismos colores y tono (por ejemplo alertas con borde ocre o success/warning del tema username).  
   - Enlaces y botones secundarios: coherentes en todo el dashboard (usuario y admin).  
   - Si en algún sitio quedan referencias a “Jorge Chacón”, “Beyond Contact Center” o otro producto, sustituirlas por “username” / “tu empresa” y el contexto PMU.
...
- Un repaso de consistencia en loading, errores y microcopy para que toda la experiencia se sienta de una sola pieza y de marca “tu empresa”.
