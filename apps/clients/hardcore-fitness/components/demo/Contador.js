 ...
 *   completo → las cuatro cifras en cajas, para el muro y el bloque de venta.
 */
export default function Contador({ formato = "compacto", className = "" }) {
  ...
  // Las cajas van en `.cristal`, que es el acabado de toda la tienda: así el
  // contador no parece pegado de otro sitio.
  return (
    <div className={`flex gap-2 ${className}`}>
      {cajas.map((caja) => (
        <div key={caja.etiqueta} className="cristal min-w-14 px-2 py-2 text-center">
