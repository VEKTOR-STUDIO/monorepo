...
const list = [
  {
    ...
    text: "Esta herramienta ha revolucionado la forma en que operamos nuestro negocio.",
    img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=200&q=80",
  },
  {
    username: "salon.template",
    name: "Nombre del Cliente",
    text: "Proceso de citas claro y una presencia online que transmite confianza desde el primer clic.",
  },
  {
    username: "pmu.reference",
    name: "Nombre del Cliente",
    text: "Plantilla sólida: personalizamos textos e imágenes sin tocar la lógica que ya funciona.",
  },
];
