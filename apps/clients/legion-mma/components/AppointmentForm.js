      ...
      <div className="relative bg-base-100/80 backdrop-blur-md border border-base-content/10 rounded-2xl p-6 md:p-8 shadow-xl overflow-hidden">
        ...
        {success && (
          <div className="alert alert-success mb-6">
            ...
            <span>¡Cita agendada exitosamente! Te contactaremos pronto.</span>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-semibold text-sm md:text-base">Empresa/Negocio</span>
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-base-content/40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="form-control">
            ...
            <div className="relative">
              <textarea
                ...
                placeholder="¿Qué desafíos enfrentas? ¿Qué quieres lograr con IA y automatización?"
              />
            </div>
          </div>
        ...
        <div className="mt-6 p-4 bg-base-200 rounded-lg">
          <p className="text-sm text-base-content/70">
            <strong>Note:</strong> We&apos;ll confirm availability by email
            within 24 hours. Booking slots are limited monthly.
          </p>
        </div>
      </div>
    </div>
