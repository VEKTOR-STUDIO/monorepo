#!/usr/bin/env node
/**
 * Genera el favicon de tu empresa: "F" en ocre sobre fondo negro.
...
const sizes = [16, 32, 64, 180]; // 180 para apple-touch-icon
...
// Favicon principal (64x64 es un buen estándar para SVG favicon)
const svg64 = buildSvg(64);
writeFileSync(join(publicDir, "favicon.svg"), svg64.trim(), "utf8");
console.log("✓ public/favicon.svg (64×64)");

// Opcional: versiones en distintos tamaños para referencia
...
console.log("\nFavicon generado: F en ocre (#C69C6D) sobre fondo negro (#1A1A1A).");
