...
// carrocería, y no una división por sedes: Kings Cars tiene un solo local, en
// el C.C.C.T., y su propia publicación fijada parte el mundo en dos columnas
// tituladas "VIEJOS" y "NUEVOS". Son dos compradores que no se parecen: uno
// busca el mejor usado que le alcance y el otro viene a estrenar. Por eso la
// `condicion` manda sobre todo lo demás y la carrocería queda en segundo nivel.
//
...
/**
 * El primer corte, y es el suyo: su publicación fijada parte el catálogo en dos
 * columnas, "VIEJOS" y "NUEVOS". Aquí se escriben con más cuidado, pero el
 * corte es ese.
 *
 * El usado va PRIMERO porque es lo que de verdad mueve esta casa: casi todo su
 * inventario es de segunda mano y ahí es donde tienen el ojo.
 */
export const CONDICIONES = [
  {
    ...
    plural: "usados",
    resumen:
      "Revisados uno a uno antes de entrar al salón, con su kilometraje y su transmisión a la vista.",
  },
  {
    slug: "nuevo",
    nombre: "0 km",
 ...
 *
 * Son las cinco que se mueven en el mercado de usados de Caracas, que es donde
 * vende esta casa. No hay camiones ni furgones: esa es otra clase de negocio y
 ...
 * así que casi todos los precios del JSON son referencias de mercado hasta que
 * se lea su cuenta entera o el cliente cargue los suyos. Lo usa el aviso de la
