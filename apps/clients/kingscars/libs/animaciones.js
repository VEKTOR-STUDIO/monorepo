...
//
// El movimiento de esta página no es decorativo. La gráfica de Kings Cars es
// una corona calada sobre piedra y unas tarjetas blancas que rematan cada
// publicación, así que aquí las cosas no barren: ASOMAN y se posan. Las líneas
// del titular suben desde detrás de una máscara, las tarjetas de datos entran
// una detrás de otra como se leen en sus posts, y los rombos de la corona se
// deslizan despacio al fondo. Nada gira, nada se inclina: en su logotipo no hay
// una sola curva ni una sola diagonal caprichosa.
//
...
/**
 * El ángulo del rombo de la marca, en grados.
 *
 * Es la inclinación de los dos rombos huecos de la base de su corona, y es la
 * ÚNICA que existe en todo el emblema: las letras y el pico van a plomo. Por
 * eso se reserva para piezas pequeñas y para las capas de fondo, nunca para un
 * titular. Tiene que ir a la par con --angulo-kc de app/globals.css.
 */
export const ANGULO = -16;
 ...
 * no aparece: ASOMA. Es el movimiento que mejor traduce el rótulo blanco que
 * remata cada publicación suya, que también entra desde abajo sobre la foto.
 *
