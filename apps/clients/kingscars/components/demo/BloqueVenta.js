      ...
      <div className="relative mx-auto max-w-5xl px-4 py-20 sm:px-6">
        ...
        <Revelar retraso={140}>
          <p className="mx-auto mt-6 max-w-lg text-center leading-relaxed text-base-content/60">
            ...
            corona y la gráfica de tus publicaciones. Lo que falta por poner es tu
        ...
        <Revelar retraso={180}>
          <p className="mx-auto mt-6 max-w-lg text-center text-xs text-base-content/35">
            De todo el inventario que ves, solo el Corolla GLI 2006 es tuyo —su
            kilometraje, su transmisión y su precio, leídos de tu publicación—; el
            resto son unidades de muestra con precios de referencia. Tampoco hay ni
            una foto tuya: Instagram limitó las peticiones mientras se montaba esto, y
