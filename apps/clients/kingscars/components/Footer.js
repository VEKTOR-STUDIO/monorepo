 ...
 * legales.
 *
 * "C.C.C.T." va en bloque propio y no escondido en una línea de texto: aquí la
 * ubicación es identidad —está metida en el nombre de su cuenta— y quien llega
 * buscando "dónde están" tiene que encontrarlo sin leer un párrafo.
 *
 * Y va con "previa cita" pegado al lado, porque una dirección sin esa
 * advertencia es una invitación a presentarse sin avisar.
 */
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="min-w-0 lg:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-base-content/50">
              {business.lema}. Avalúo, fotos, promoción y seguimiento, sin cobrarte
              nada.
            </p>
          </div>
          ...
          <div className="min-w-0">
            ...
            <p className="mt-3 text-sm text-primary">Previa cita</p>
          </div>
