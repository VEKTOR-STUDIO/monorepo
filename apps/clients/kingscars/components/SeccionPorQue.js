...
//
// Es la objeción real de ESTE cliente, y no una genérica. Kings Cars tiene
// 6.567 seguidores y 902 publicaciones. Les funciona. Cualquier argumento que
// empiece por "Instagram no sirve" es falso y además se nota, así que la
// sección empieza reconociendo lo contrario.
//
...
//
// Hay una fila que en esta casa pesa más que en otras: la de VENDER. Su mejor
// producto es que publican gratis el carro de cualquiera, y eso hoy solo lo
// sabe quien se lee la bio o encuentra el post fijado.
//
// Habla el vendedor del sistema, no Kings Cars: por eso va en la zona marcada
...
const COMPARACION = [
  ...
  },
  {
    ...
    instagram:
      "902 publicaciones que se pasan con el dedo. Quien quiera un sedán automático de menos de 15.000 tiene que ir mirando cuadro por cuadro.",
    pagina:
  ...
  {
    tema: "Que publicas gratis",
    instagram:
      "Está en la bio y en un post fijado. Quien entra a mirar carros no lo lee, y ese es justo el que tiene uno que vender.",
    pagina:
      "Una página entera para eso, con su formulario de avalúo, y un enlace en el menú que se ve en todas las pantallas. Es tu mejor producto y hoy es lo más escondido que tienes.",
  },
  {
  ...
  },
  {
    ...
    instagram:
      "No te encuentra. Un post de Instagram no aparece cuando alguien busca «Corolla 2006 Caracas» ni «vender mi carro CCCT».",
    pagina:
  ...
  },
  {
    ...
    instagram:
      "De Instagram. Si la cierran, la hackean o le bajan el alcance, se van con ella las 902 publicaciones y los 6.567 seguidores.",
    pagina:
