                ...
                <Revelar retraso={180}>
                  ...
                  <div className="mt-8">
                    ...
                    <p className="mt-2 text-sm text-base-content/60">
                      Se ve y se prueba en {vehiculo.ubicacion}, con cita previa
                    </p>
                  </div>
                </Revelar>
                  ...
                  <div className="mt-8">
                    {demo ? (
                      <AvisoBloqueado titulo="El contacto está desactivado en la demo">
                        ...
                        {vehiculo.anio}, ¿sigue disponible? Quisiera agendar una cita
                        para verlo»— para que el comprador no tenga que explicar nada y
                        la cita quede pedida en el primer mensaje.
                      </AvisoBloqueado>
                    ) : (
                      <BotonContacto
                        vehiculo={vehiculo}
            ...
            <div className="mt-20 grid gap-12 border-t border-base-content/10 pt-12 lg:grid-cols-2 lg:gap-20">
              <Revelar>
                ...
                <p className="mt-8 text-sm leading-relaxed text-base-content/45">
                  Se ve y se prueba en {config.business.direccionLarga}. Aquí se atiende
                  con cita previa: escribe antes y te la apartan para la hora que
                  acordéis.
                </p>
              </Revelar>
