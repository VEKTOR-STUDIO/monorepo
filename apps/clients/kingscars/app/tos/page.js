      ...
      <div className="mt-10 space-y-8 leading-relaxed text-base-content/75">
        <section>
          ...
          <p className="mt-3">
            ...
            publica lo que hay en el salón; la venta se cierra en persona, con cita
            previa. La página no cobra, no procesa pagos y no retiene dinero de ninguna
            operación.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            {config.business.direccion}, previa cita— y llevarla a un taller de
